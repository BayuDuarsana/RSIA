          ...
          <div class="col-lg-12">
            ...
            <div class="card-header">
              <div class="card-tools">
                  <a href="#" class="btn btn-success" disabled>Tambah Data</a>
              </div>
            </div>
                  ...
                  <tbody>
                    @foreach ($user as $item)
                          <tr>
                              ...
                              <td>{{ implode(', ', $item->jabatan->pluck('nama')->toArray()) }}</td>
                              <td>{{ $item->tanggal_bergabung }}</td>
                              <td>
                                  <button class="btn btn-sm btn-warning float-left">Edit</button>
                                  <form method="post" action="{{ route('user.destroy', ['id' => $item->id]) }}" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-sm btn-danger float-left mx-3" onclick="return confirm('Apakah Anda yakin ingin menghapus user ini?')">Delete</button>
                                  </form>
                              </td>
                          </tr>
                      @endforeach
